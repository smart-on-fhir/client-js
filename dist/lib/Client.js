...
class Client extends FhirClient_1.default {
    ...
    constructor(environment, state) {
        ...
        this.patient = {
            ...
            read: (requestOptions) => {
                ...
                return id ?
                    this.request(Object.assign(Object.assign({}, requestOptions), { url: `Patient/${id}` })) :
        ...
        this.encounter = {
            ...
            read: requestOptions => {
                ...
                return id ?
                    this.request(Object.assign(Object.assign({}, requestOptions), { url: `Encounter/${id}` })) :
        ...
        this.user = {
            ...
            read: requestOptions => {
                ...
                return fhirUser ?
                    this.request(Object.assign(Object.assign({}, requestOptions), { url: fhirUser })) :
    ...
    refresh(requestOptions = {}) {
        ...
        if (!this._refreshTask) {
            ...
            const refreshRequestOptions = Object.assign(Object.assign({ credentials: this.environment.options.refreshTokenWithCredentials || "same-origin" }, requestOptions), { method: "POST", mode: "cors", headers: Object.assign(Object.assign({}, (requestOptions.headers || {})), { "content-type": "application/x-www-form-urlencoded" }), body: body });
