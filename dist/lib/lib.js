...
async function request(url, requestOptions = {}) {
    ...
    return fetch(url, Object.assign(Object.assign({ mode: "cors" }, options), { headers: Object.assign({ accept: "application/json" }, loweCaseKeys(options.headers)) }))
        .then(checkResponse)
        .then((res) => {
        ...
        if (!body && res.status == 201) {
            ...
            if (location) {
                ...
                return request(location, Object.assign(Object.assign({}, options), { method: "GET", body: null, includeResponse }));
            }
        }
        if (includeResponse) {
