...
exports.assertJsonPatch = exports.assert = exports.getTargetWindow = exports.getPatientParam = exports.byCodes = exports.byCode = exports.getAccessTokenExpiration = exports.getTimeInFuture = exports.jwtDecode = exports.randomString = exports.absolute = exports.makeArray = exports.setPath = exports.getPath = exports.fetchConformanceStatement = exports.getAndCache = exports.request = exports.loweCaseKeys = exports.responseToJSON = exports.checkResponse = exports.units = void 0;
...
async function getTargetWindow(target, width = 800, height = 720) {
    ...
    if (typeof target != "string") {
        (0, debug_1.debug)("Invalid target type '%s'. Failing back to '_self'.", typeof target);
        return self;
    }
    // Current window
    if (target == "_self") {
    ...
    if (target == "_blank") {
        ...
        if (!targetWindow) {
            (0, debug_1.debug)("Cannot open window. Failing back to '_self'. %s", error);
            return self;
        }
        else {
            return targetWindow;
    ...
    (0, debug_1.debug)("Unknown target '%s'. Failing back to '_self'.", target);
    return self;
}
