...
if (!((_a = globalThis === null || globalThis === void 0 ? void 0 : globalThis.crypto) === null || _a === void 0 ? void 0 : _a.subtle)) {
    ...
    throw new Error("Some of the required subtle crypto functionality is not " +
        ...
        "Please use a polyfill to provide this functionality.");
}
...
async function signCompactJws(alg, privateKey, header, payload) {
    const jwtHeader = JSON.stringify(Object.assign(Object.assign({}, header), { alg }));
    ...
    const signature = await subtle.sign(Object.assign(Object.assign({}, privateKey.algorithm), { hash: 'SHA-384' }), privateKey, new TextEncoder().encode(jwtAuthenticatedContent));
