...
class FhirClient {
    ...
    async create(resource, requestOptions) {
        return this.fhirRequest(resource.resourceType, Object.assign(Object.assign({}, requestOptions), { method: "POST", body: JSON.stringify(resource), headers: Object.assign({ "content-type": "application/json" }, (requestOptions || {}).headers) }));
    }
    /**
    ...
    async update(resource, requestOptions) {
        return this.fhirRequest(`${resource.resourceType}/${resource.id}`, Object.assign(Object.assign({}, requestOptions), { method: "PUT", body: JSON.stringify(resource), headers: Object.assign({ "content-type": "application/json" }, (requestOptions || {}).headers) }));
    }
    /**
    ...
    async delete(url, requestOptions = {}) {
        return this.fhirRequest(url, Object.assign(Object.assign({}, requestOptions), { method: "DELETE" }));
    }
    /**
    ...
    async patch(url, patch, requestOptions = {}) {
        ...
        return this.fhirRequest(url, Object.assign(Object.assign({}, requestOptions), { method: "PATCH", body: JSON.stringify(patch), headers: Object.assign({ "prefer": "return=presentation", "content-type": "application/json-patch+json; charset=UTF-8" }, requestOptions.headers) }));
    }
    async resolveRef(obj, path, graph, cache, requestOptions = {}) {
        ...
        if (node) {
            ...
            return Promise.all((0, lib_1.makeArray)(node).filter(Boolean).map((item, i) => {
                ...
                if (ref) {
                    return this.fhirRequest(ref, Object.assign(Object.assign({}, requestOptions), { includeResponse: false, cacheMap: cache })).then(sub => {
                        if (graph) {
                            if (isArray) {
                                if (path.indexOf("..") > -1) {
    ...
    resources(bundleOrUrl, options) {
        return __asyncGenerator(this, arguments, function* resources_1() {
            ...
            let count = 0;
            try {
                for (var _d = true, _e = __asyncValues(this.pages(bundleOrUrl, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
    ...
    pages(bundleOrUrl, requestOptions) {
        return __asyncGenerator(this, arguments, function* pages_1() {
            var _a, _b;
            const _c = requestOptions || {}, { limit } = _c, options = __rest(_c, ["limit"]);
    ...
    async getFhirVersion() {
        return (0, lib_1.fetchConformanceStatement)(this.fhirBaseUrl)
