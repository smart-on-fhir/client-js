// @ts-nocheck
(() => {
"use strict";var FHIR=(()=>{var ft=Object.create;var se=Object.defineProperty;var ht=Object.getOwnPropertyDescriptor;var dt=Object.getOwnPropertyNames;var pt=Object.getPrototypeOf,gt=Object.prototype.hasOwnProperty;var pe=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Fe=(t,e)=>{for(var r in e)se(t,r,{get:e[r],enumerable:!0})},ke=(t,e,r,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of dt(e))!gt.call(t,n)&&n!==r&&se(t,n,{get:()=>e[n],enumerable:!(i=ht(e,n))||i.enumerable});return t};var mt=(t,e,r)=>(r=t!=null?ft(pt(t)):{},ke(e||!t||!t.__esModule?se(r,"default",{value:t,enumerable:!0}):r,t)),yt=t=>ke(se({},"__esModule",{value:!0}),t);var Te=pe((dr,ve)=>{var $=1e3,J=$*60,N=J*60,D=N*24,wt=D*7,Rt=D*365.25;ve.exports=function(t,e){e=e||{};var r=typeof t;if(r==="string"&&t.length>0)return bt(t);if(r==="number"&&isFinite(t))return e.long?xt(t):Ct(t);throw new Error("val is not a non-empty string or a valid number. val="+JSON.stringify(t))};function bt(t){if(t=String(t),!(t.length>100)){var e=/^(-?(?:\d+)?\.?\d+) *(milliseconds?|msecs?|ms|seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)?$/i.exec(t);if(e){var r=parseFloat(e[1]),i=(e[2]||"ms").toLowerCase();switch(i){case"years":case"year":case"yrs":case"yr":case"y":return r*Rt;case"weeks":case"week":case"w":return r*wt;case"days":case"day":case"d":return r*D;case"hours":case"hour":case"hrs":case"hr":case"h":return r*N;case"minutes":case"minute":case"mins":case"min":case"m":return r*J;case"seconds":case"second":case"secs":case"sec":case"s":return r*$;case"milliseconds":case"millisecond":case"msecs":case"msec":case"ms":return r;default:return}}}}function Ct(t){var e=Math.abs(t);return e>=D?Math.round(t/D)+"d":e>=N?Math.round(t/N)+"h":e>=J?Math.round(t/J)+"m":e>=$?Math.round(t/$)+"s":t+"ms"}function xt(t){var e=Math.abs(t);return e>=D?oe(t,e,D,"day"):e>=N?oe(t,e,N,"hour"):e>=J?oe(t,e,J,"minute"):e>=$?oe(t,e,$,"second"):t+" ms"}function oe(t,e,r,i){var n=e>=r*1.5;return Math.round(t/r)+" "+i+(n?"s":"")}});var _e=pe((pr,Ee)=>{function St(t){r.debug=r,r.default=r,r.coerce=f,r.disable=o,r.enable=n,r.enabled=l,r.humanize=Te(),r.destroy=u,Object.keys(t).forEach(a=>{r[a]=t[a]}),r.names=[],r.skips=[],r.formatters={};function e(a){let c=0;for(let g=0;g<a.length;g++)c=(c<<5)-c+a.charCodeAt(g),c|=0;return r.colors[Math.abs(c)%r.colors.length]}r.selectColor=e;function r(a){let c,g=null,h,p;function m(...w){if(!m.enabled)return;let y=m,O=Number(new Date),j=O-(c||O);y.diff=j,y.prev=c,y.curr=O,c=O,w[0]=r.coerce(w[0]),typeof w[0]!="string"&&w.unshift("%O");let U=0;w[0]=w[0].replace(/%([a-zA-Z%])/g,(Z,P)=>{if(Z==="%%")return"%";U++;let T=r.formatters[P];if(typeof T=="function"){let L=w[U];Z=T.call(y,L),w.splice(U,1),U--}return Z}),r.formatArgs.call(y,w),(y.log||r.log).apply(y,w)}return m.namespace=a,m.useColors=r.useColors(),m.color=r.selectColor(a),m.extend=i,m.destroy=r.destroy,Object.defineProperty(m,"enabled",{enumerable:!0,configurable:!1,get:()=>g!==null?g:(h!==r.namespaces&&(h=r.namespaces,p=r.enabled(a)),p),set:w=>{g=w}}),typeof r.init=="function"&&r.init(m),m}function i(a,c){let g=r(this.namespace+(typeof c>"u"?":":c)+a);return g.log=this.log,g}function n(a){r.save(a),r.namespaces=a,r.names=[],r.skips=[];let c=(typeof a=="string"?a:"").trim().replace(/\s+/g,",").split(",").filter(Boolean);for(let g of c)g[0]==="-"?r.skips.push(g.slice(1)):r.names.push(g)}function s(a,c){let g=0,h=0,p=-1,m=0;for(;g<a.length;)if(h<c.length&&(c[h]===a[g]||c[h]==="*"))c[h]==="*"?(p=h,m=g,h++):(g++,h++);else if(p!==-1)h=p+1,m++,g=m;else return!1;for(;h<c.length&&c[h]==="*";)h++;return h===c.length}function o(){let a=[...r.names,...r.skips.map(c=>"-"+c)].join(",");return r.enable(""),a}function l(a){for(let c of r.skips)if(s(a,c))return!1;for(let c of r.names)if(s(a,c))return!0;return!1}function f(a){return a instanceof Error?a.stack||a.message:a}function u(){console.warn("Instance method `debug.destroy()` is deprecated and no longer does anything. It will be removed in the next major version of `debug`.")}return r.enable(r.load()),r}Ee.exports=St});var Oe=pe((x,ae)=>{x.formatArgs=Ft;x.save=kt;x.load=At;x.useColors=Pt;x.storage=Ut();x.destroy=(()=>{let t=!1;return()=>{t||(t=!0,console.warn("Instance method `debug.destroy()` is deprecated and no longer does anything. It will be removed in the next major version of `debug`."))}})();x.colors=["#0000CC","#0000FF","#0033CC","#0033FF","#0066CC","#0066FF","#0099CC","#0099FF","#00CC00","#00CC33","#00CC66","#00CC99","#00CCCC","#00CCFF","#3300CC","#3300FF","#3333CC","#3333FF","#3366CC","#3366FF","#3399CC","#3399FF","#33CC00","#33CC33","#33CC66","#33CC99","#33CCCC","#33CCFF","#6600CC","#6600FF","#6633CC","#6633FF","#66CC00","#66CC33","#9900CC","#9900FF","#9933CC","#9933FF","#99CC00","#99CC33","#CC0000","#CC0033","#CC0066","#CC0099","#CC00CC","#CC00FF","#CC3300","#CC3333","#CC3366","#CC3399","#CC33CC","#CC33FF","#CC6600","#CC6633","#CC9900","#CC9933","#CCCC00","#CCCC33","#FF0000","#FF0033","#FF0066","#FF0099","#FF00CC","#FF00FF","#FF3300","#FF3333","#FF3366","#FF3399","#FF33CC","#FF33FF","#FF6600","#FF6633","#FF9900","#FF9933","#FFCC00","#FFCC33"];function Pt(){if(typeof window<"u"&&window.process&&(window.process.type==="renderer"||window.process.__nwjs))return!0;if(typeof navigator<"u"&&navigator.userAgent&&navigator.userAgent.toLowerCase().match(/(edge|trident)\/(\d+)/))return!1;let t;return typeof document<"u"&&document.documentElement&&document.documentElement.style&&document.documentElement.style.WebkitAppearance||typeof window<"u"&&window.console&&(window.console.firebug||window.console.exception&&window.console.table)||typeof navigator<"u"&&navigator.userAgent&&(t=navigator.userAgent.toLowerCase().match(/firefox\/(\d+)/))&&parseInt(t[1],10)>=31||typeof navigator<"u"&&navigator.userAgent&&navigator.userAgent.toLowerCase().match(/applewebkit\/(\d+)/)}function Ft(t){if(t[0]=(this.useColors?"%c":"")+this.namespace+(this.useColors?" %c":" ")+t[0]+(this.useColors?"%c ":" ")+"+"+ae.exports.humanize(this.diff),!this.useColors)return;let e="color: "+this.color;t.splice(1,0,e,"color: inherit");let r=0,i=0;t[0].replace(/%[a-zA-Z%]/g,n=>{n!=="%%"&&(r++,n==="%c"&&(i=r))}),t.splice(i,0,e)}x.log=console.debug||console.log||(()=>{});function kt(t){try{t?x.storage.setItem("debug",t):x.storage.removeItem("debug")}catch{}}function At(){let t;try{t=x.storage.getItem("debug")||x.storage.getItem("DEBUG")}catch{}return!t&&typeof process<"u"&&"env"in process&&(t=process.env.DEBUG),t}function Ut(){try{return localStorage}catch{}}ae.exports=_e()(x);var{formatters:It}=ae.exports;It.j=function(t){try{return JSON.stringify(t)}catch(e){return"[UnexpectedJSONParseError]: "+e.message}}});var cr={};Fe(cr,{FhirClient:()=>M,authorize:()=>ot,createSmartClient:()=>ct,default:()=>ar,init:()=>at,ready:()=>st,settings:()=>ut,utils:()=>lt});var Q=class extends Error{statusCode;status;statusText;response;constructor(e){super(`${e.status} ${e.statusText}
...
This app cannot be accessed directly. Please launch it as SMART app!`,a):a}).catch(a=>{throw a.status==403&&n("Permission denied! Please make sure that you have requested the proper scopes."),a}).then(async a=>!a||typeof a=="string"||a instanceof Response?e.includeResponse?{body:a,response:u}:a:(await this.fetchReferences(a,o.resolveReferences,o.graph,i,e),Promise.resolve(a).then(async c=>{if(c&&c.resourceType=="Bundle"){let g=c.link||[];if(o.flat&&(c=(c.entry||[]).map(h=>h.resource)),o.onPage&&await o.onPage(c,{...i}),--o.pageLimit){let h=g.find(p=>p.relation=="next");if(c=B(c),h&&h.url){let p=await this.request({url:h.url,signal:l},o,i);return o.onPage?null:o.resolveReferences.length?(Object.assign(i,p.references),c.concat(B(p.data||p))):c.concat(B(p))}}}return c}).then(c=>{if(o.graph)i={};else if(!o.onPage&&o.resolveReferences.length)return{data:c,references:i};return c}).then(c=>e.includeResponse?{body:c,response:u}:c)))}refreshIfNeeded(e={}){let r=this.getState("tokenResponse.access_token"),i=this.getState("tokenResponse.refresh_token"),n=this.state.expiresAt||0;return r&&i&&n-10<Date.now()/1e3?this.refresh(e):Promise.resolve(this.state)}refresh(e={}){let r=S.extend("client:refresh");r("Attempting to refresh with refresh_token...");let i=this.state?.tokenResponse?.refresh_token;d(i,"Unable to refresh. No refresh_token found.");let n=this.state.tokenUri;d(n,"Unable to refresh. No tokenUri found.");let s=this.getState("tokenResponse.scope")||"",o=s.search(/\boffline_access\b/)>-1,l=s.search(/\bonline_access\b/)>-1;if(d(o||l,"Unable to refresh. No offline_access or online_access scope found."),!this._refreshTask){let f=`grant_type=refresh_token&refresh_token=${encodeURIComponent(i)}`;this.environment.options.refreshTokenWithClientId&&(f+=`&client_id=${this.state.clientId}`);let u={credentials:this.environment.options.refreshTokenWithCredentials||"same-origin",...e,method:"POST",mode:"cors",headers:{...e.headers||{},"content-type":"application/x-www-form-urlencoded"},body:f};if(!("authorization"in u.headers)){let{clientSecret:a,clientId:c}=this.state;a&&(u.headers.authorization="Basic "+this.environment.btoa(c+":"+a))}this._refreshTask=_(n,u).then(a=>(d(a.access_token,"No access token received"),r("Received new access token response %O",a),this.state.tokenResponse={...this.state.tokenResponse,...a},this.state.expiresAt=le(a,this.environment),this.state)).catch(a=>{throw this.state?.tokenResponse?.refresh_token&&(r("Deleting the expired or invalid refresh token."),delete this.state.tokenResponse.refresh_token),a}).finally(()=>{this._refreshTask=null;let a=this.state.key;a?this.environment.getStorage().set(a,this.state):r("No 'key' found in Clint.state. Cannot persist the instance.")})}return this._refreshTask}byCode(e,r){return Re(e,r)}byCodes(e,r){return He(e,r)}units=Be;getPath(e,r=""){return k(e,r)}getState(e=""){return k({...this.state},e)}};var C=S.extend("oauth2");function W(){return typeof window=="object"}async function Ot(t="/",e){let r=String(t).replace(/\/*$/,"/")+".well-known/smart-configuration";return ye(r,e).catch(i=>{throw new Error(`Failed to fetch the well-known json "${r}". ${i.message}`)})}async function qt(t="/",e){return Ot(t,e).then(r=>{if(!r.authorization_endpoint||!r.token_endpoint)throw new Error("Invalid wellKnownJson");return{registrationUri:r.registration_endpoint||"",authorizeUri:r.authorization_endpoint,tokenUri:r.token_endpoint,codeChallengeMethods:r.code_challenge_methods_supported||[]}})}async function Bt(t="/",e){return K(t,e).then(r=>{let i="http://fhir-registry.smarthealthit.org/StructureDefinition/oauth-uris",n=(k(r||{},"rest.0.security.extension")||[]).filter(o=>o.url===i).map(o=>o.extension)[0],s={registrationUri:"",authorizeUri:"",tokenUri:"",codeChallengeMethods:[]};return n&&n.forEach(o=>{o.url==="register"&&(s.registrationUri=o.valueUri),o.url==="authorize"&&(s.authorizeUri=o.valueUri),o.url==="token"&&(s.tokenUri=o.valueUri)}),s})}async function Mt(t="/",e,r){return qt(t,e).catch(()=>Bt(t,r))}async function fe(t,e={}){let r=t.getUrl();if(Array.isArray(e)){let R=r.searchParams.get("iss")||r.searchParams.get("fhirServiceUrl");if(!R)throw new Error('Passing in an "iss" url parameter is required if authorize uses multiple configurations');let q=e.find(H=>{if(H.issMatch){if(typeof H.issMatch=="function")return!!H.issMatch(R);if(typeof H.issMatch=="string")return H.issMatch===R;if(H.issMatch instanceof RegExp)return H.issMatch.test(R)}return!1});return d(q,`No configuration found matching the current "iss" parameter "${R}"`),await fe(t,q)}let{clientSecret:i,fakeTokenResponse:n,encounterId:s,target:o,width:l,height:f,pkceMode:u,clientPublicKeySetUrl:a,redirect_uri:c,client_id:g}=e,{iss:h,launch:p,patientId:m,fhirServiceUrl:w,redirectUri:y,noRedirect:O,scope:j="",clientId:U,completeInTarget:Y,clientPrivateJwk:Z,stateKey:P}=e,T=t.getStorage();h=r.searchParams.get("iss")||h,w=r.searchParams.get("fhirServiceUrl")||w,p=r.searchParams.get("launch")||p,m=r.searchParams.get("patientId")||m,U=r.searchParams.get("clientId")||U,U||(U=g),y||(y=c),y?y.match(/^https?\:\/\//)||(y=t.relative(y)):y=t.relative(".");let L=String(h||w||"");if(!L)throw new Error("No server url found. It must be specified as `iss` or as `fhirServiceUrl` parameter");if(h&&C("Making %s launch...",p?"EHR":"standalone"),p&&!j.match(/launch/)&&(j+=" launch"),W()){let R=$e(),q=Je();(R||q)&&Y!==!0&&Y!==!1&&(Y=R,console.warn('Your app is being authorized from within an iframe or popup window. Please be explicit and provide a "completeInTarget" option. Use "true" to complete the authorization in the same window, or "false" to try to complete it in the parent or the opener window. See http://docs.smarthealthit.org/client-js/api.html'))}let Se=await T.get(E);await T.unset(Se),P=P??Me(16);let F={clientId:U,scope:j,redirectUri:y,serverUrl:L,clientSecret:i,clientPrivateJwk:Z,tokenResponse:{},key:P,completeInTarget:Y,clientPublicKeySetUrl:a};(W()?k(t,"options.fullSessionStorageSupport"):!0)&&await T.set(E,P),n&&Object.assign(F.tokenResponse,n),m&&Object.assign(F.tokenResponse,{patient:m}),s&&Object.assign(F.tokenResponse,{encounter:s});let v=y+"?state="+encodeURIComponent(P);if(w&&!h)return C("Making fake launch..."),await T.set(P,F),O?v:await t.redirect(v);let Pe=await Mt(L,e.wellKnownRequestOptions,e.conformanceRequestOptions);if(Object.assign(F,Pe),await T.set(P,F),!F.authorizeUri)return O?v:await t.redirect(v);let ie=["response_type=code","client_id="+encodeURIComponent(U||""),"scope="+encodeURIComponent(j),"redirect_uri="+encodeURIComponent(y),"aud="+encodeURIComponent(L),"state="+encodeURIComponent(P)];if(p&&ie.push("launch="+encodeURIComponent(p)),zt(Pe.codeChallengeMethods.includes("S256"),u)){let R=await t.security.generatePKCEChallenge();Object.assign(F,R),await T.set(P,F),ie.push("code_challenge="+F.codeChallenge),ie.push("code_challenge_method=S256")}if(v=F.authorizeUri+"?"+ie.join("&"),O)return v;if(o&&W()){let R;if(R=await je(o,l,f),R!==self)try{R.sessionStorage.removeItem(Se),R.sessionStorage.setItem(P,JSON.stringify(F))}catch(q){S('Failed to modify window.sessionStorage. Perhaps it is from different origin?. Failing back to "_self". %s',q),R=self}if(R!==self)try{R.location.href=v,self.addEventListener("message",Ne)}catch(q){S('Failed to modify window.location. Perhaps it is from different origin?. Failing back to "_self". %s',q),self.location.href=v}else self.location.href=v;return}else return await t.redirect(v)}function zt(t,e){if(e==="disabled")return!1;if(e==="unsafeV1")return!0;if(e==="required"){if(!t)throw new Error("Required PKCE code challenge method (`S256`) was not found in the server's codeChallengeMethods declaration.");return!0}return t}function $e(){try{return self!==top&&parent!==self}catch{return!0}}function Je(){try{return self===top&&!!opener&&opener!==self&&!!window.name}catch{return!1}}function Ne(t){t.data.type=="completeAuth"&&t.origin===new URL(self.location.href).origin&&(window.removeEventListener("message",Ne),window.location.href=t.data.url)}async function be(t,e={}){let r=t.getUrl(),i=t.getStorage(),n=r.searchParams,s=n.get("state")||e.stateKey,o=n.get("code")||e.code,l=n.get("error"),f=n.get("error_description");if(s||(s=await i.get(E)),l||f)throw new Error([l,f].filter(Boolean).join(": "));C("key: %s, code: %s",s,o),d(s,"No 'state' parameter found. Please (re)launch the app.");let u=await i.get(s),a=W()?k(t,"options.fullSessionStorageSupport"):!0;if(W()&&u&&!u.completeInTarget){let p=$e(),m=Je();if((p||m)&&!r.searchParams.get("complete")){r.searchParams.set("complete","1");let{href:w,origin:y}=r;return p&&parent.postMessage({type:"completeAuth",url:w},y),m&&(opener.postMessage({type:"completeAuth",url:w},y),window.close()),new Promise(()=>{})}}r.searchParams.delete("complete");let c=!!(n.has("state")||e.stateKey);if(W()&&k(t,"options.replaceBrowserHistory")&&(o||c)&&(o&&(n.delete("code"),C("Removed code parameter from the url.")),c&&a&&(n.delete("state"),C("Removed state parameter from the url.")),window.history.replaceState&&window.history.replaceState({},"",r.href)),d(u,"No state found! Please (re)launch the app."),!(!o||u.tokenResponse?.access_token)&&u.tokenUri){d(o,"'code' url parameter is required"),C("Preparing to exchange the code for access token...");let p=await Ht(t,{code:o,state:u,clientPublicKeySetUrl:e.clientPublicKeySetUrl,privateKey:e.privateKey||u.clientPrivateJwk});C("Token request options: %O",p);let m=await _(u.tokenUri,p);C("Token response: %O",m),d(m.access_token,"Failed to obtain access token."),u.expiresAt=le(m,t),u={...u,tokenResponse:m},await i.set(s,u),C("Authorization successful!")}else C(u.tokenResponse?.access_token?"Already authorized":"No authorization needed");a&&await i.set(E,s);let h=new z(t,u);return C("Created client instance: %O",h),h}async function Ht(t,{code:e,state:r,clientPublicKeySetUrl:i,privateKey:n}){let{redirectUri:s,clientSecret:o,tokenUri:l,clientId:f,codeVerifier:u}=r;d(s,"Missing state.redirectUri"),d(l,"Missing state.tokenUri"),d(f,"Missing state.clientId");let a={method:"POST",headers:{"content-type":"application/x-www-form-urlencoded"},body:`code=${e}&grant_type=authorization_code&redirect_uri=${encodeURIComponent(s)}`};if(o)a.headers.authorization="Basic "+t.btoa(f+":"+o),C("Using state.clientSecret to construct the authorization header: %s",a.headers.authorization);else if(n){let c="key"in n?n.key:await t.security.importJWK(n),g={typ:"JWT",kid:n.kid,jku:i||r.clientPublicKeySetUrl},h={iss:f,sub:f,aud:l,jti:t.base64urlencode(t.security.randomBytes(32)),exp:ze(120)},p=await t.security.signCompactJws(n.alg,c,g,h);a.body+=`&client_assertion_type=${encodeURIComponent("urn:ietf:params:oauth:client-assertion-type:jwt-bearer")}`,a.body+=`&client_assertion=${encodeURIComponent(p)}`,C("Using state.clientPrivateJwk to add a client_assertion to the POST body")}else C("Public client detected; adding state.clientId to the POST body"),a.body+=`&client_id=${encodeURIComponent(f)}`;return u&&(C("Found state.codeVerifier, adding to the POST body"),a.body+="&code_verifier="+u),a}async function Ke(t,e,r){let i=t.getUrl(),n=i.searchParams.get("code"),s=i.searchParams.get("state");if(n&&s)return be(t,r);let o=t.getStorage(),l=s||await o.get(E),f=await o.get(l);return f?new z(t,f):fe(t,e).then(()=>new Promise(()=>{}))}var ee=class{async get(e){let r=sessionStorage[e];return r?JSON.parse(r):null}async set(e,r){return sessionStorage[e]=JSON.stringify(r),r}async unset(e){return e in sessionStorage?(delete sessionStorage[e],!0):!1}};var de={};Fe(de,{digestSha256:()=>it,generatePKCEChallenge:()=>tr,importJWK:()=>rr,randomBytes:()=>nt,signCompactJws:()=>nr});var V=typeof Buffer=="function",We=typeof TextDecoder=="function"?new TextDecoder:void 0,Ve=typeof TextEncoder=="function"?new TextEncoder:void 0,Dt="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",te=Array.prototype.slice.call(Dt),he=(t=>{let e={};return t.forEach((r,i)=>e[r]=i),e})(te),jt=/^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/,b=String.fromCharCode.bind(String),Ge=typeof Uint8Array.from=="function"?Uint8Array.from.bind(Uint8Array):t=>new Uint8Array(Array.prototype.slice.call(t,0)),Ze=t=>t.replace(/=/g,"").replace(/[+\/]/g,e=>e=="+"?"-":"_"),Qe=t=>t.replace(/[^A-Za-z0-9\+\/]/g,""),Lt=t=>{let e,r,i,n,s="",o=t.length%3;for(let l=0;l<t.length;){if((r=t.charCodeAt(l++))>255||(i=t.charCodeAt(l++))>255||(n=t.charCodeAt(l++))>255)throw new TypeError("invalid character found");e=r<<16|i<<8|n,s+=te[e>>18&63]+te[e>>12&63]+te[e>>6&63]+te[e&63]}return o?s.slice(0,o-3)+"===".substring(o):s},Xe=typeof btoa=="function"?t=>btoa(t):V?t=>Buffer.from(t,"binary").toString("base64"):Lt,Ce=V?t=>Buffer.from(t).toString("base64"):t=>{let r=[];for(let i=0,n=t.length;i<n;i+=4096)r.push(b.apply(null,t.subarray(i,i+4096)));return Xe(r.join(""))},G=(t,e=!1)=>e?Ze(Ce(t)):Ce(t),$t=t=>{if(t.length<2){var e=t.charCodeAt(0);return e<128?t:e<2048?b(192|e>>>6)+b(128|e&63):b(224|e>>>12&15)+b(128|e>>>6&63)+b(128|e&63)}else{var e=65536+(t.charCodeAt(0)-55296)*1024+(t.charCodeAt(1)-56320);return b(240|e>>>18&7)+b(128|e>>>12&63)+b(128|e>>>6&63)+b(128|e&63)}},Jt=/[\uD800-\uDBFF][\uDC00-\uDFFFF]|[^\x00-\x7F]/g,Nt=t=>t.replace(Jt,$t),Ye=V?t=>Buffer.from(t,"utf8").toString("base64"):Ve?t=>Ce(Ve.encode(t)):t=>Xe(Nt(t)),Kt=(t,e=!1)=>e?Ze(Ye(t)):Ye(t),re=t=>Kt(t,!0),Wt=/[\xC0-\xDF][\x80-\xBF]|[\xE0-\xEF][\x80-\xBF]{2}|[\xF0-\xF7][\x80-\xBF]{3}/g,Vt=t=>{switch(t.length){case 4:var e=(7&t.charCodeAt(0))<<18|(63&t.charCodeAt(1))<<12|(63&t.charCodeAt(2))<<6|63&t.charCodeAt(3),r=e-65536;return b((r>>>10)+55296)+b((r&1023)+56320);case 3:return b((15&t.charCodeAt(0))<<12|(63&t.charCodeAt(1))<<6|63&t.charCodeAt(2));default:return b((31&t.charCodeAt(0))<<6|63&t.charCodeAt(1))}},Gt=t=>t.replace(Wt,Vt),Yt=t=>{if(t=t.replace(/\s+/g,""),!jt.test(t))throw new TypeError("malformed base64.");t+="==".slice(2-(t.length&3));let e,r,i,n=[];for(let s=0;s<t.length;)e=he[t.charAt(s++)]<<18|he[t.charAt(s++)]<<12|(r=he[t.charAt(s++)])<<6|(i=he[t.charAt(s++)]),r===64?n.push(b(e>>16&255)):i===64?n.push(b(e>>16&255,e>>8&255)):n.push(b(e>>16&255,e>>8&255,e&255));return n.join("")},et=typeof atob=="function"?t=>atob(Qe(t)):V?t=>Buffer.from(t,"base64").toString("binary"):Yt,Zt=V?t=>Ge(Buffer.from(t,"base64")):t=>Ge(et(t).split("").map(e=>e.charCodeAt(0)));var Qt=V?t=>Buffer.from(t,"base64").toString("utf8"):We?t=>We.decode(Zt(t)):t=>Gt(et(t)),Xt=t=>Qe(t.replace(/[-_]/g,e=>e=="-"?"+":"/")),tt=t=>Qt(Xt(t));if(!globalThis?.crypto?.subtle)throw globalThis.isSecureContext?new Error("Some of the required subtle crypto functionality is not available in the current environment (no crypto.subtle). Please use a polyfill to provide this functionality."):new Error("Some of the required subtle crypto functionality is not available unless you run this app in secure context (using HTTPS or running locally). See https://developer.mozilla.org/en-US/docs/Web/Security/Secure_Contexts");var rt=globalThis.crypto,xe=rt.subtle,er={ES384:{name:"ECDSA",namedCurve:"P-384"},RS384:{name:"RSASSA-PKCS1-v1_5",modulusLength:4096,publicExponent:new Uint8Array([1,0,1]),hash:{name:"SHA-384"}}};function nt(t){return rt.getRandomValues(new Uint8Array(t))}async function it(t){let e=new TextEncoder().encode(t),r=await xe.digest("SHA-256",e);return new Uint8Array(r)}var tr=async(t=96)=>{let e=nt(t),r=G(e,!0);return{codeChallenge:G(await it(r),!0),codeVerifier:r}};async function rr(t){if(!t.alg)throw new Error('The "alg" property of the JWK must be set to "ES384" or "RS384"');if(Array.isArray(t.key_ops)||(t.key_ops=["sign"]),!t.key_ops.includes("sign"))throw new Error('The "key_ops" property of the JWK does not contain "sign"');try{return await xe.importKey("jwk",t,er[t.alg],t.ext===!0,t.key_ops)}catch(e){throw new Error(`The ${t.alg} is not supported by this browser: ${e}`)}}async function nr(t,e,r,i){let n=JSON.stringify({...r,alg:t}),s=JSON.stringify(i),o=`${re(n)}.${re(s)}`,l=await xe.sign({...e.algorithm,hash:"SHA-384"},e,new TextEncoder().encode(o));return`${o}.${G(new Uint8Array(l),!0)}`}var ne=class{_url=null;_storage=null;options;security=de;constructor(e={}){this.options={replaceBrowserHistory:!0,fullSessionStorageSupport:!0,refreshTokenWithCredentials:"same-origin",...e}}relative(e){return new URL(e,this.getUrl().href).href}get fhir(){return typeof fhir=="function"?fhir:null}getUrl(){return this._url||(this._url=new URL(location+"")),this._url}redirect(e){location.href=e}getStorage(){return this._storage||(this._storage=new ee),this._storage}atob(e){return window.atob(e)}btoa(e){return window.btoa(e)}base64urlencode(e){return typeof e=="string"?re(e):G(e,!0)}base64urldecode(e){return tt(e)}getSmartApi(){return{ready:(...e)=>be(this,...e),authorize:e=>fe(this,e),init:e=>Ke(this,e),client:e=>new z(this,e),options:this.options,utils:{security:de}}}};var ir=new ne,{ready:st,authorize:ot,init:at,client:ct,options:ut,utils:lt}=ir.getSmartApi(),sr={settings:ut,ready:st,authorize:ot,init:at};var or={client:ct,FhirClient:M,utils:lt,oauth2:sr},ar=or;return yt(cr);})();
