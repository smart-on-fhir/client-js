...
declare const FHIR: {
    ...
    oauth2: {
        ...
        init: (options: import("../types").fhirclient.AuthorizeParams | import("../types").fhirclient.AuthorizeParams[]) => Promise<never | import("../Client").default>;
    };
};
export default FHIR;
