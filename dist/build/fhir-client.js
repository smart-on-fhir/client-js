...
URL: ${response.url}`);
  ...
  // src/settings.ts
  var patientCompartment, fhirVersions, patientParams, SMART_KEY;
  ...
  async function request(url, requestOptions = {}) {
    ...
    return fetch(url, {
      ...
      if (!body && res.status == 201) {
        ...
        if (location2) {
          return request(location2, { ...options, method: "GET", body: null, includeResponse });
        }
      }
      if (includeResponse) {
  ...
  // src/FhirClient.ts
  var debug2, FhirClient;
  var init_FhirClient = __esm({
    "src/FhirClient.ts"() {
      "use strict";
      init_settings();
      init_lib();
      debug2 = _debug.extend("FhirClient");
      FhirClient = class {
        /**
        ...
        async fhirRequest(uri, options = {}) {
          ...
          if (cacheMap) {
            if (!(path in cacheMap)) {
              cacheMap[path] = request(url, options).then((res) => {
                cacheMap[path] = res;
                return res;
              }).catch((error) => {
  ...
  var init_Client = __esm({
    "src/Client.ts"() {
      ...
      init_settings();
      init_FhirClient();
      debug3 = _debug.extend("client");
      Client = class extends FhirClient {
        /**
         * Validates the parameters, creates an instance and tries to connect it to
         * FhirJS, if one is available globally.
         */
  ...
  async function ready(env, options = {}) {
    ...
    debug4("Created client instance: %O", client);
    return client;
  }
  ...
  var debug4;
  var init_smart = __esm({
    "src/smart.ts"() {
      "use strict";
      init_lib();
      init_Client();
      init_settings();
      debug4 = _debug.extend("oauth2");
    }
  });
  ...
  var _hasBuffer, _TD, _TE, b64ch, b64chs, b64tab, b64re, _fromCC, _U8Afrom, _mkUriSafe, _tidyB64, btoaPolyfill, _btoa, _fromUint8Array, fromUint8Array, cb_utob, re_utob, utob, _encode, encode, encodeURI, re_btou, cb_btou, btou, atobPolyfill, _atob, _toUint8Array, _decode, _unURI, decode;
  ...
  var crypto, subtle, ALGS, generatePKCEChallenge;
  var init_browser = __esm({
    "src/security/browser.ts"() {
      ...
      generatePKCEChallenge = async (entropy = 96) => {
  ...
  var require_browser2 = __commonJS({
    "src/entry/browser.ts"(exports, module) {
      init_BrowserAdapter();
      init_FhirClient();
