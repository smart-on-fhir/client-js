...
|scope       |`String`  | One or more space-separated scopes that you would like to request from the EHR. [Learn more](https://www.hl7.org/fhir/smart-app-launch/scopes-and-launch-context.html)
